  ...
  return (
    <PageLayout>
      <SEO 
        ...
        imageUrl={featuredPost?.imageUrl || "/lovable-uploads/sspp.png"}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {blogPosts.length < 4 && Array.from({ length: Math.max(0, 4 - blogPosts.length) }).map((_, index) => (
            <BlogPostCard 
              ...
              imageUrl={index % 2 === 0 ? "/lovable-uploads/sspp.png" : "/lovable-uploads/700e27d7-0513-4bfa-8ac4-f7fd6087594c.png"}
              date="Coming soon"
              slug="#"
              category="Upcoming"
            />
