...
// EmailJS configuration is now centralized in src/config/emailjs.ts
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        message: `Sender Name: ${emailData.name}\nSender Email: ${emailData.email}\n\nMessage:\n${emailData.message}`,
      ...
      const response = await emailjs.send(
        ...
        {
          ...templateParams,
          event_id: EMAILJS_EVENT_ID, // optional event tracking
        },
        EMAILJS_PUBLIC_KEY
      );
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                field
                      ...
                      <div className="relative">
                        ...
                        <FormControl>
                          <Input type="email" placeholder="your.work.email@example.com" className="pl-10" {...field} />
                        </FormControl>
                      </div>
                      <FormMessage />
                    </FormItem>} />
