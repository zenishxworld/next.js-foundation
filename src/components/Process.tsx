...
// ✅ Updated Digital Product Agency Process Steps
const processes = [
  {
    id: 1,
    title: "Discovery & Strategy",
    description:
      "We collaborate to understand your product vision, business goals, target users, and technical requirements. This stage ensures clarity, accuracy, and a solid foundation before development starts.",
    steps: [
      "Goal definition and problem understanding",
      "User research and competitor analysis",
      "Technical feasibility and architecture planning",
      "Project scope and roadmap creation",
    ],
  },
  {
    id: 2,
    ...
    description:
      "Our design team converts ideas into intuitive user journeys, wireframes, and interactive prototypes, giving you a clear visual understanding of your product before development.",
    steps: [
  ...
  },
  {
    ...
    description:
      "We build fast, scalable, and secure digital products—from websites and mobile apps to AI-powered automation—using modern technologies and clean coding practices.",
    steps: [
      "Frontend and backend development",
      "API setup and cloud integration",
      "AI/automation feature implementation",
  ...
  },
  {
    ...
    description:
      "Your product goes through performance testing, security checks, and quality reviews before being deployed to production with zero downtime.",
    steps: [
  ...
  },
  {
    ...
    description:
      "We help you launch smoothly, track performance, and scale your product with continuous updates, enhancements, and technical support.",
    steps: [
...
const Process = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (closestSection !== null) setActiveProcess(closestSection + 1);
    };
      ...
      <div className="container mx-auto px-4" ref={processRef}>
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            A clear, structured 5-phase workflow that takes your web, mobile, or AI
            product from idea to fully deployed, scalable reality.
          </p>
        </div>
